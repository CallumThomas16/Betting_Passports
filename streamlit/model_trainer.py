...
def train_model():
    ...
    joblib.dump(ae, 'session_duration_model.pkl')


def load_daily_stake_model(model_path='models/daily_stake_model.pkl'):
    try:            
...
def load_num_bets_model(model_path='models/num_bets_normal.pkl'):
    try:            
        model = joblib.load(model_path)
        return model
    except:
...
def load_login_hour_model(model_path='models/login_hour_normal.pkl'):
    try:            
        model = joblib.load(model_path)
        return model
    except:
...
def load_session_duration_model(model_path='models/session_duration_normal.pkl'):
    try:            
        model = joblib.load(model_path)
        return model
    except:
...
def load_days_since_deposit_model(model_path='models/days_since_deposit_model.pkl'):
    try:            
        model = joblib.load(model_path)
        return model
    except:
...
def load_foreign_ip_model(model_path='models/foreign_ip_normal_model.pkl'):
    try:            
        model = joblib.load(model_path)
        return model
    except:
